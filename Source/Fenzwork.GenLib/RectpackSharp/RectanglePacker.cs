...
namespace RectpackSharp
{
    ...
    public static class RectanglePacker
    {
        ...
        /// </remarks>
        /// <returns>True if solution is found, otherwise false.</returns>
#if NET5_0_OR_GREATER
        public static bool Pack(Span<PackingRectangle> rectangles, out PackingRectangle bounds,
...
#elif NETSTANDARD2_1
        public static bool Pack(PackingRectangle[] rectangles, out PackingRectangle bounds,
            PackingHints packingHint = PackingHints.FindBest, double acceptableDensity = 1, uint stepSize = 1,
            uint? maxBoundsWidth = null, uint? maxBoundsHeight = null)
#endif
        {
            ...
            if (rectangles.Length == 0)
                throw new ArgumentOutOfRangeException(nameof(rectangles.Length), rectangles.Length, "Unexpected length to be 0.");
